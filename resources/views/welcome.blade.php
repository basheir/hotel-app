...
<html lang="zxx">
	<head>
        ...
        <!-- Custom CSS -->
        <link href="{{URL::asset('frontend/assets/css/styles.css')}}" rel="stylesheet">
		
		<!-- Custom Color Option -->
		<link href="{{URL::asset('frontend/assets/css/colors.css')}}" rel="stylesheet">
    ...
    <body class="blue-skin">
        ...
        <div id="main-wrapper">
					...
					<nav id="navigation" class="navigation navigation-landscape">
						...
						<div class="nav-menus-wrapper" style="transition-property: none;">
							...
							<ul class="nav-menu nav-menu-social align-to-right">
								...
								<li>
									<a href="submit-property.html" class="text-light"><img src="assets/img/submit.svg" width="20" alt="" class="mr-2" />Add Hotel Now</a>
								</li>
								<li class="add-listing light">
									<a href="JavaScript:Void(0);" data-bs-toggle="modal" data-bs-target="#login"><img src="assets/img/user.svg" width="12" alt="" class="mr-2" />Sign In</a>
								</li>
							</ul>
						</div>
					</nav>
			...
			<!-- ============================ Hero Banner  Start================================== -->
			<div class="image-cover hero-banner" style="background:url(https://images.unsplash.com/photo-1631049307264-da0ec9d70304?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80) no-repeat;" data-overlay="6">
				<div class="container">
			...
			<!-- ============================ Smart Testimonials ================================== -->
			<section class="image-cover" style="background:url(https://via.placeholder.com/1920x900) no-repeat;" data-overlay="5">
				<div class="container">
					<div class="row justify-content-center">
		...
		<script src="{{URL::asset('frontend/assets/js/rangeslider.js')}}"></script>
		<script src="{{URL::asset('frontend/assets/js/select2.min.js')}}"></script>
		...
		<script src="{{URL::asset('frontend/assets/js/slider-bg.js')}}"></script>
		<script src="{{URL::asset('frontend/assets/js/lightbox.js')}}"></script> 
		<script src="{{URL::asset('frontend/assets/js/imagesloaded.js')}}"></script>
